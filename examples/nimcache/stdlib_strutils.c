...
N_LIB_PRIVATE N_NIMCALL(NIM_CHAR, nsuToUpperAsciiChar)(NIM_CHAR c) {
	...
	nimln_(230, "strutils.nim");
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_23 = subInt(((NU8)(c)), ((NI) 32));
		result = ((NIM_CHAR) (((NI)chckRange((NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_23), ((NI) 0), ((NI) 255)))));
	}
	goto LA1_;
	LA3_: ;
	{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuToUpperAsciiStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_22 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		colontmp_ = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_22);
		nimln_(2045, "system.nim");
		res = ((NI) 0);
		{
			nimln_(2046, "system.nim");
			while (1) {
				...
				nimln_(2048, "system.nim");
				TM_JGc9b9bh2D3nTdUR7TGyq8aA_24 = addInt(res, ((NI) 1));
				res = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_24);
			} LA3: ;
		}
	}
	popFrame();
